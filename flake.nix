    ...
    in {
      devShells.default = pkgs.mkShell {
        buildInputs = with pkgs; [
          ...
          # Native dependencies for Complement integration testing
          go
          olm

	  # Native dependencies for building Synapse's documentation
	  mdbook

	  # Native dependencies for linting Synapse
	  ruff

          # Python dependency management tooling
          poetry
        ];
